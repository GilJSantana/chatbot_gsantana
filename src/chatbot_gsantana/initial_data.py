...
from chatbot_gsantana import models  # Garante que todos os modelos sejam importados
...
def main() -> None:
    ...
    if settings.TEST_ADMIN_USERNAME:
        logger.info("Creating initial admin user for testing...", username=settings.TEST_ADMIN_USERNAME)

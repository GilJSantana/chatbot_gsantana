...
[![CI/CD Pipeline](https://github.com/GilJSantana/chatbot_gsantana/actions/workflows/ci.yml/badge.svg)](https://github.com/GilJSantana/chatbot_gsantana/actions/workflows/ci.yml)
[![Sync Wiki](https://github.com/GilJSantana/chatbot_gsantana/actions/workflows/wiki-sync.yml/badge.svg)](https://github.com/GilJSantana/chatbot_gsantana/actions/workflows/wiki-sync.yml)
[![Docker Image](https://img.shields.io/badge/docker-ghcr.io-blue?logo=docker)](https://github.com/GilJSantana/chatbot_gsantana/pkgs/container/chatbot_gsantana)
...
*   **[🏠 Home da Wiki](https://github.com/GilJSantana/chatbot_gsantana/wiki)**
*   **[Especificação do Projeto](https://github.com/GilJSantana/chatbot_gsantana/wiki/Especificacao-do-Projeto)**
*   **[Arquitetura do Sistema](https://github.com/GilJSantana/chatbot_gsantana/wiki/Arquitetura-do-Sistema)**
*   **[Modelo C4](https://github.com/GilJSantana/chatbot_gsantana/wiki/Modelo-C4)**
*   **[Guias de Uso](https://github.com/GilJSantana/chatbot_gsantana/wiki/Guias-de-Uso)**
*   **[Interface Administrativa](https://github.com/GilJSantana/chatbot_gsantana/wiki/Interface-Administrativa)**
